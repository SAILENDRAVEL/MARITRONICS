...
const LiveMap = () => {
  ...
  const districtKey = boat.district?.trim().toLowerCase();
  ...
  const shoreCoords =
    districtRadar[districtKey] || [8.7642, 78.1348];
